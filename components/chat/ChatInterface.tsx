  ...
  const handleNewMessage = (message: Message) => {
    logger.info('[Chat] New message received:', {
      ...
      messageStructure: {
        ...
        senderStructure: message.sender ? {
          hasId: !!message.sender.id,
          hasDisplayName: !!message.sender.displayName,
          hasImageUrl: !!message.sender.imageUrl,
